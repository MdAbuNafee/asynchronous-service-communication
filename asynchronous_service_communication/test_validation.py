    ...
    def test_get_session_post_data_validity_error(self):
        test_case_list = [
            ...
            TestCaseCommon(
                ...
                expected_output=[
                    'station id is not a valid uuid'
                ],
            ...
            TestCaseCommon(
                ...
                expected_output=[
                    'driver token contains invalid character !'
                ],
            ...
            TestCaseCommon(
                input={
                    ...
                    "driver_token": "validDriverToken1234567",
                    "callback_url":
                        "https://webhook/a02530e4-62e6-433b-ae31"
                        "-d1392e823f12"
                },
                expected_output=[
                    'callback_url is not a valid URL'
